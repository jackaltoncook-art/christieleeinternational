...
**Rotating routes.** Three of six additional real destinations (Cancun,
Rome, Sydney, Cairo, London, and a permanently DELAYED Las Vegas) rotate
onto the board each hour, so it changes all night. **Captain Air flight
CA-040 to PARIS** — the featured departure — leaves gate 40 at the top of
every hour with a golden flyover and confetti.
...
**Cadence: continuous.** With announcements on, the PA never goes quiet
for more than about 10 seconds. Flight calls (boarding, last call,
departed, in the formal house style) take priority; whenever the queue
empties, the ambient rotation resumes within 7 seconds: the Welcome
message, the original **Captain Air** promo, the Happy 40th Birthday
announcement, TSA security notices, the lost wallet at TSA, Captain Air
check-in and service notices, the Phoenix cancellation, and the local
time — cycling forever, no input required. Anyone walking past the
entrance hears the terminal speaking.
