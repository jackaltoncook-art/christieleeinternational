...
Tap **Announcements on** once and the airport talks — real speech, using
the device's built-in voices (free, offline, no accounts):

- **Four announcers** — two gate agents, a duty manager, and a roving
  announcer — with distinct voices, pitch, and pace.
- **Flight calls** in the formal CLI house style: *"Ladies and gentlemen,
  Japan Airlines flight J L 40, service to Tokyo, is now boarding at
  gate A 2…"* plus last calls and departure notices.
- **The classics**, cycling at :03, :20, :35, :50 — the Welcome message,
  the **Captain Air** promo, and the Happy 40th Birthday announcement.
- **The comedy desk**, at :09, :14, :26, :31, :44, :57 — lost wallet at
  TSA, paging Hugh Jest, the moving walkway situation, someone's thirties
  at lost & found, and more.
